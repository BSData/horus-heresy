            ...
            <selectionEntry id="3ebb-a8ef-429f-d050" name="Evoker of Pain" hidden="true" collective="false" import="true" type="upgrade">
              ...
              <profiles>
                <profile id="a8b4-6196-1d45-24d5" name="Evoker of Pain" publicationId="09c5-eeae-f398-b653" page="256" hidden="false" typeId="a0e6-a7b4-d55d-85b8" typeName="Warlord Trait">
                  <characteristics>
                    <characteristic name="Text" typeId="c68e-2cda-b67b-baca">When a Warlord with this Trait fails a Psychic check and suffers Perils of the Warp , neither the Warlord nor any models in a unit it has joined suffer any Wounds. Instead , select one enemy unit that either has at least one model w ithin 6&quot; of the Warlord with this Trait, or is
locked in combat with the Warlord with this Trait. The selected enemy unit suffers D3 Wounds against which only Invulnerable Saves may be made and no Damage Mitigation rolls may be made, if there is no valid enemy unit within 6&quot; then resolve Perils of the Warp against the Warlord ’s unit as normal. Wounds inflicted in this manner during the Assault phase do not count for resolving the
winner of a combat and never cause Morale checks or Pinning tests. In addition , an army whose Warlord has this Trait may make an additional Reaction during the opposing player’s Assault phase as long as the Warlord has not been removed as a casualty.</characteristic>
                  </characteristics>
                </profile>
              </profiles>
              <costs>
